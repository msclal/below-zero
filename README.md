...
**IMPORTANT: Any changes made to files in this GitHub repository will automatically trigger Vercel to deploy the latest version of the website with your new file changes.**
...
1. Locate the file `public/data/store_info.js`. The file should look like this:
    ...
    ```
2. For example, you would modify the "sunday" field to indicate that Sunday is closed:
   ```
    export const storeInfo = {
        hours: {
            monday: "Closed",
...
1. **Add a picture**
   ...
   - For example, the image for 'Sad Day Rainbow' should be named `SadDayRainbow.webp` under the folder name `SadDayRainbow` in the Combos folder. The file path location should be `public/product_pictures/combos/SadDayRainbow/SadDayRainbow.webp`.
...
*The following section was automatically generated by Next.js (the JavaScript coding framework used to create this website).*
### Getting Started
