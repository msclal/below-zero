  ...
  return (
    <div className="relative flex flex-col justify-between w-full min-[1350px]:w-5/12 h-full self-start font-outfit">
      <div className="flex flex-col">
        <motion.div
          className={`${selectedMenuItem === 0 && "bg-secondary-filter text-primary "} p-6 rounded-lg cursor-pointer transition-all duration-300 ease-in-out `}
          onClick={() => onMenuItemClick(0)}
        >
          <p className="mb-3 font-semibold">SHAVED ICE</p>
          <p className="text-base font-light text-text-subtext">
