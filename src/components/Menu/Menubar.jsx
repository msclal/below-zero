...
const Menubar = ({ selectedMenuItem, onMenuItemClick }) => {
  return (
    <div className="w-full sticky">
      ...
      <div className="relative flex flex-col w-full pl-[35%] font-medium gap-y-3.5">
        <p
          className={`p-4 rounded-r-lg cursor-pointer transition-all duration-300 ease-in-out hover:bg-below-zero-blue-200/90 hover:text-white   ${selectedMenuItem === "SHAVED ICE" ? "bg-below-zero-blue-200 text-white" : "text-black bg-white border border-border"}`}
