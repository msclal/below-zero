  ...
  return (
    <>
      <div className="flex flex-col w-full">
        ...
        <div className="border ml-5 max-lg:space-y-[8%] rounded-b flex max-lg:p-8 pr-8 sm:py-8">
          <div className=" w-full sm:flex">
            <div className="lg:ml-[5%] max-lg:w-full w-6/12  ">
              ...
              <div className="flex max-sm:flex-wrap sm:space-x-[8%]">
                <ul className="grid whitespace-nowrap gap-x-[20%] lg:pr-[5%] max-sm:gap-x-[50%] max-sm:grid-cols-2 max-sm:pb-[12%] sm:grid-cols-2 2xl:grid-cols-3  max-sm:mr-[7%] list-disc list-inside">
            ...
            <div className="flex w-6/12 max-lg:w-full lg:pl-[5%]">
              <div className="w-full max-lg:w-full">
                ...
                <div className="flex">
                  <ul className="w-full list-disc list-inside text-nowrap">
                    <li>Cake Batter</li>
                    <li>Cookie Dough</li>
                    <li>Cotton Candy</li>
